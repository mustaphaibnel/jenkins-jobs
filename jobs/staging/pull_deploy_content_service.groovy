pipelineJob('pull_deploy_content_service') {
    description('Pull and Deploy Job for Content Service with Environment Support')

    parameters {
        stringParam('ENVIRONMENT', 'staging', 'Environment name (e.g., staging, production)')
        stringParam('SERVICE_NAME', 'content-service', 'Service name (e.g., content-service, building-service)')
        stringParam('DB_NAME', 'content_db', 'Database name associated with the service')
...
pipeline {
    ...
    environment {
        ...
        SEQUELIZE_DB = "\${env.STAGING_CONTENT_SERVICE_SEQUELIZE_DB}"
        SEQUELIZE_USERNAME = "\${env.STAGING_CONTENT_SERVICE_SEQUELIZE_USERNAME}"
        SEQUELIZE_PASSWORD = "\${env.STAGING_CONTENT_SERVICE_SEQUELIZE_PASSWORD}"
        SEQUELIZE_HOST = "\${env.STAGING_CONTENT_SERVICE_SEQUELIZE_HOST}"
        SEQUELIZE_PORT = "\${env.STAGING_CONTENT_SERVICE_SEQUELIZE_PORT}"
        NODE_ENV = "development"
        SERVICE_PORT = "\${env.STAGING_CONTENT_SERVICE_PORT}"
