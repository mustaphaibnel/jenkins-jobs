pipelineJob('pull_deploy_assistance_service') {
    description('Pull and Deploy Job for Assistance Service with Environment Support')

    parameters {
        stringParam('ENVIRONMENT', 'staging', 'Environment name (e.g., staging, production)')
        stringParam('SERVICE_NAME', 'assistance-service', 'Service name (e.g., assistance-service, building-service)')
        stringParam('DB_NAME', 'assistance_db', 'Database name associated with the service')
...
pipeline {
    ...
    environment {
        ...
        SEQUELIZE_DB = "\${env.STAGING_ASSISTANCE_SERVICE_SEQUELIZE_DB}"
        SEQUELIZE_USERNAME = "\${env.STAGING_ASSISTANCE_SERVICE_SEQUELIZE_USERNAME}"
        SEQUELIZE_PASSWORD = "\${env.STAGING_ASSISTANCE_SERVICE_SEQUELIZE_PASSWORD}"
        SEQUELIZE_HOST = "\${env.STAGING_ASSISTANCE_SERVICE_SEQUELIZE_HOST}"
        SEQUELIZE_PORT = "\${env.STAGING_ASSISTANCE_SERVICE_SEQUELIZE_PORT}"
        NODE_ENV = "development"
        SERVICE_PORT = "\${env.STAGING_ASSISTANCE_SERVICE_PORT}"
