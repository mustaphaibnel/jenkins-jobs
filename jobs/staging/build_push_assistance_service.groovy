pipelineJob('build_push_assistance_service') {
    description('Build and Push Job for assistance-service with configurable parameters for AWS credentials, GitHub credentials, Docker tag, and AWS account.')
    parameters {
        stringParam('REPO_URL', 'https://github.com/viven-app/assistance-service.git', 'GitHub Repository URL')
        stringParam('ORG_NAME', 'viven-app', 'Organization Name')
        stringParam('BRANCH', 'DEVOPS-1', 'Git Branch')
        stringParam('ECR_REPO', 'assistance-service', 'AWS ECR Repository Name')
...
pipeline {
    ...
    parameters {
        string(name: 'REPO_URL', defaultValue: 'https://github.com/viven-app/assistance-service.git', description: 'GitHub Repository URL')
        ...
        string(name: 'ECR_REPO', defaultValue: 'assistance-service', description: 'AWS ECR Repository Name')
